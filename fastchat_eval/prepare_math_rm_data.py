...
if __name__ == "__main__":
    input_file = "/workspace/zhiqings/output3/data/train_rm.json"
    output_file = "data/math_rm/question.jsonl"
        ...
        output_data.append(
            {
                ...
                "level": d["level"] if "level" in d else "GSM8K",
                "type": d["type"] if "type" in d else "GSM8K",
            }
        )
