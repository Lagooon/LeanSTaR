...
BETA=0.0002
VARIANT=rpo-cringe
SAVE_FILE_NAME=alpaca-7b-rpo_cringe_epoch-${EPOCH}_lr-${LR}_bs-${BS}_beta-${BETA}-v2

# --dpo_pm_checkpoint_path $DATA_DIR/checkpoints/alpaca-7b-pm_epoch-1_lr-2e-6_seq-2048-v7 \
...
#     --dataset "/nobackup/users/yikangs/zhiqings/dpo/alpaca_rm_10k_v2.json" \
...
MODEL_NAME=$VARIANT-7b-cringe-10k-lr-${LR}-bs-${BS}-beta-${BETA}
