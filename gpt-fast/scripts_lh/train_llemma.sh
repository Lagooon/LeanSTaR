...
export MODEL_PATH='/lustre/fast/fast/wliu/longhui/trust_math_ckpt/checkpoints/llemma-7b_metamath_v3_5e-6_1_2_3_4_5'
export SAVE_PATH="/lustre/fast/fast/wliu/longhui/trust_math_ckpt/checkpoints/llemma-7b_metamath_v3_5e-6_1_2_3_4_5_debug"
export MASTER_ADDR="localhost"
export MASTER_PORT="1231"
export GLOO_SOCKET_IFNAME="lo"
export NCCL_SOCKET_IFNAME="lo"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --master_addr ${MASTER_ADDR} --master_port ${MASTER_PORT} --nproc_per_node=8 --use_env train_llemma.py \
    --model_name_or_path $MODEL_PATH \
    --data_path "/home/wliu/longhui/llms-all/ScalableMath_sun-main/data/train_1_2_3_metamath_v3_mapped.json" \
