...
def main(
    ...
    prm_data_path: str = "/nobackup/users/yikangs/zhiqings/math/train_1_2_3_prm_v5_rm.json",
    prompt_path: str = "/nobackup/users/yikangs/zhiqings/math/train_1to5_prm_v3.json",
    sample_path: str = "/nobackup/users/yikangs/zhiqings/math/outputs/train_1to5_prm_v3_34b-v4_epoch-3_lr-2e-5_seq-768_s32.jsonl",
    output_path: str = "/nobackup/users/yikangs/zhiqings/math/train_1_2_3_prm_v5_oprm_34b.json",
    max_ratio: float = 3.0,
    limiter: int = 16,
):
    ...
    for sample in tqdm.tqdm(samples):
        ...
        id2sample[idx].append(
            {
                "input": input_text,
                "output_prefix": output_text.split("\n\n# Answer\n\n")[0],
                "output": "\n\n# Answer\n\n" + pred_answer,
