...
torchrun --standalone --nproc_per_node=8 \
    ...
    --save_dir $DATA_DIR/checkpoints/llemma-34b-rm_sft-init-toet_prm-1-2-3-v4_epoch-2_lr-1e-5_seq-768-bf16-amp \
    --report_to "wandb" \
    --wandb_project "scalable-math-sft" \
    --wandb_entity "zhiqings" \
    --wandb_name "llemma-34b_rm-sft-init-toet-1-2-3_epoch-2_lr-1e-5_seq-768-bf16-amp" \
    --param_dtype fp32 \
    --optim_dtype fp32 \
