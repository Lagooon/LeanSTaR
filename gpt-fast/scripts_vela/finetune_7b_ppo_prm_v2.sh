...
torchrun --standalone --nproc_per_node=8 \
    ...
    --ppo_warmup_steps 5 \
    --seed 42 \
    --dataset "$DATA_DIR/train_1to5_1-2-3_prm_ppo.json" \
    --eval_dataset "$DATA_DIR/test_1to5_1-2-3_prm_ppo.json" \
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-v2 \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-v2" \
    --wandb_project "scalable-math-ppo" \
