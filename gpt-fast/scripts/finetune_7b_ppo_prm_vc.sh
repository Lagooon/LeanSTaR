...
torchrun --standalone --nproc_per_node=8 \
    ...
    --save_steps 5 \
    --save_total_limit 1 \
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vb \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vanilla-vb" \
