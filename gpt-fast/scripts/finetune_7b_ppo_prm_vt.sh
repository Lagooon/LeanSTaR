...
torchrun --standalone --nproc_per_node=8 \
    ...
    --eval_dataset "/nobackup/users/yikangs/zhiqings/math/test_1to5_1-2-3_prm_ppo.json" \
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vt \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vanilla-vt" \
