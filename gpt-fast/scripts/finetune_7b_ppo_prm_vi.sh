...
torchrun --standalone --nproc_per_node=4 \
    ...
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vi \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vanilla-vi" \
