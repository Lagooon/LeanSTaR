...
torchrun --standalone --nproc_per_node=4 \
    ...
    --ppo_warmup_steps 5 \
    --seed 42 \
    --dataset "/nobackup/users/yikangs/zhiqings/math/train_4to5_4-5_prm_ppo.json" \
    --save_strategy steps \
    --save_steps 5 \
    --save_total_limit 1 \
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-4to5_epoch-10_lr-1e-5_seq-768-v3 \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-4to5_epoch-10_lr-1e-5_seq-768-vanilla-v3" \
