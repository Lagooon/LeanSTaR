...
torchrun --standalone --nproc_per_node=8 \
    ...
    --sft_checkpoint_path $DATA_DIR/checkpoints/llemma-34b_prm-1-2-3_epoch-3_lr-1e-5_seq-768 \
    --source_max_len 768 \
    --target_max_len 768 \
    --total_max_len 768 \
    ...
    --save_dir $DATA_DIR/checkpoints/llemma-34b-rm_sft-init-toet_prm-1-2-3-v4_epoch-1_lr-1e-5_seq-768 \
