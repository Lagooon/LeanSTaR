...
torchrun --standalone --nproc_per_node=8 \
    ...
    --save_steps 5 \
    --save_total_limit 1 \
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to5_epoch-10_lr-1e-5_seq-768 \
    ...
    --reward_model_bits 8 \
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to5_epoch-10_lr-1e-5_seq-768-vanilla" \
