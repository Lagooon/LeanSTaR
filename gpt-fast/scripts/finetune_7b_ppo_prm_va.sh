...
torchrun --standalone --nproc_per_node=8 \
    ...
    --ppo_warmup_steps 5 \
    --seed 42 \
    --dataset "/nobackup/users/yikangs/zhiqings/math/train_1to4_1-2-3_prm_ppo.json" \
    --save_strategy steps \
    --save_steps 5 \
    --save_total_limit 1 \
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to4_epoch-10_lr-1e-5_seq-768-v9 \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to4_epoch-10_lr-1e-5_seq-768-vanilla-v9" \
