...
torchrun --standalone --nproc_per_node=4 \
    ...
    --save_dir $DATA_DIR/checkpoints/llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vg \
    ...
    --report_to "wandb" \
    --wandb_name "llemma-7b-ppo_prm-1to5_epoch-${EPOCH}_lr-${LEARNING_RATE}_seq-768-vanilla-vg" \
    ...
    --penalty_reward_value -0.5 \
    --process_reward_upper_bound 0.7 \
