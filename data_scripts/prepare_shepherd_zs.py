...
def main(
    output_1to5_path: str = "/home/wliu/longhui/llms-all/ScalableMath_sun-main/data/processed_shepherd_v1_level1-5.json",
    output_1to3_path: str = "/home/wliu/longhui/llms-all/ScalableMath_sun-main/data/processed_shepherd_v1_level1-3.json",
    metamath_path: str = "/home/wliu/longhui/llms-all/ScalableMath_sun-main/data/MetaMathQA-395K.json",
    shepherd_path: str = "/home/wliu/longhui/llms-all/ScalableMath_sun-main/data/math-shepherd.jsonl",
    math_path: str = (
