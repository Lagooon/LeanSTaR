...
def main(
    ...
    output_path: str = "/nobackup/users/yikangs/zhiqings/math/train_1_2_3_prm_v5_rm.json",
    splitter: str = "\n\n",
):
    ...
    for ex in outputs:
        ...
        # if "pre_generated_steps" in ex:
        #     solution = splitter.join(ex["pre_generated_steps"])

        #     if solution not in generated_answer_set:
        ...
        #             }
        #         )
        #         generated_answer_set.add(solution)
