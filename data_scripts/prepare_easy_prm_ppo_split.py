...
def main(
    ...
    train_output_path: str = "/nobackup/users/yikangs/zhiqings/math/train_v2_1to5_1-2-3_prm_ppo.json",
    valid_output_path: str = "/nobackup/users/yikangs/zhiqings/math/valid_1to5_1-2-3_prm_ppo.json",
    valid_size: int = 500,
    ...
    print("MetaMath skipped:", metamath_skipped)
