...
def find_shared_prefix(str1, str2):
    ...
    while (
        not str1[:max_common_prefix].endswith("<Response 1>: ")
        and not str1[:max_common_prefix].endswith("<Response 2>: ")
        and not str1[:max_common_prefix].endswith("<Response 3>: ")
        and not str1[:max_common_prefix].endswith("<Response 4>: ")
        and not str1[:max_common_prefix].endswith("<Response 5>: ")
        and not str1[:max_common_prefix].endswith("<Response 6>: ")
        and not str1[:max_common_prefix].endswith("<Response 7>: ")
        and not str1[:max_common_prefix].endswith("<Response 8>: ")
...
def main(
    ...
    output_path: str = "/nobackup/users/yikangs/zhiqings/dpo/unified_feedback_pm_800k.json",
    preference_model_augmentation: bool = False,
):
