...
# https://huggingface.co/datasets/zhiqings/dromedary-2-70b-v2/resolve/main/cleaned_prompted_data_v2.json
...
deepspeed \
    ...
    --source_max_len 512 \
    --target_max_len 512 \
    --dataset "$DATA_DIR/cleaned_prompted_data_v2.json" \
    ...
    --bits 8 \
    --lora_r 64 \
    --output_dir "$MODEL_DIR/llemma-34b-lora-pretrain-ds" \
