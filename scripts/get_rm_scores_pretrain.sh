...
torchrun \
    ...
    --output_scoring_path "$FASTCHAT_DIR/data/math/model_answer/llemma-34b-lora-easy-sft-v4-ds-vllm-64-scored-pretrain-v3.jsonl" \
    --model_path "$MODEL_DIR/llemma-34b-lora-easy-pretrain-rm-v3-ds" \
